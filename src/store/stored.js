...
export const roleType = read('roleType') || ''
export const roleName = read('roleName') || ''
export const orgId = read('orgId') || ''
export const userId = read('userId') || ''
export const loginTime = read('loginTime') || ''
export const firstLoad = window.sessionStorage.getItem('FirstLoad') || ''
